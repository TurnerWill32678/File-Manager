...
<img src="assets/app_icon.png" width="120" alt="FM File Explorer Logo"/>
...
[![Release](https://img.shields.io/github/v/release/Raival-e/FM-File-Explorer?label=Release)](https://github.com/Raival-e/FM-File-Explorer/releases)
[![APK Downloads](https://img.shields.io/github/downloads/Raival-e/FM-File-Explorer/total.svg?label=APK%20Downloads)](https://github.com/Raival-e/FM-File-Explorer/releases)
[![Stars](https://img.shields.io/github/stars/Raival-e/FM-File-Explorer?style=flat&logo=github)](https://github.com/Raival-e/FM-File-Explorer/stargazers)
[![Forks](https://img.shields.io/github/forks/Raival-e/FM-File-Explorer?style=flat&logo=github)](https://github.com/Raival-e/FM-File-Explorer/network/members)
...
| Platform            | Link                                                                                                                                                                                                                                                                                                                                                                        |
|---------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **GitHub Releases** | [![GitHub](https://img.shields.io/badge/GitHub-Download-black?style=for-the-badge&logo=github)](https://github.com/Raival-e/FM-File-Explorer/releases)                                                                                                                                                                                                                   |
...
1. **Clone the repository**:
   ```bash
   git clone https://github.com/Raival-e/FM-File-Explorer.git
   cd FM-File-Explorer
   ```
...
![GitHub stats](https://github-readme-stats.vercel.app/api?username=Raival-e&repo=FM-File-Explorer&show_icons=true&theme=default)

---

## ☕ Support the Project

If you find **FM File Explorer** useful and would like to support its development, consider
...
```
FM File Explorer - A modern Android file manager
...
[![Star History](https://img.shields.io/github/stars/Raival-e/FM-File-Explorer?style=social)](https://github.com/Raival-e/FM-File-Explorer/stargazers)
